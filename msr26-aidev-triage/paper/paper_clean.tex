...
\begin{enumerate}
    \item \textbf{Intent Features}: These capture the agent's self-expressed goals. They include \texttt{has\_plan}, title length, and body length. We hypothesize that agents ``thinking out loud'' (Chain-of-Thought) produces higher quality code \cite{hindle2012naturalness,allamanis2018survey}.
